...
<section class="app-dashboard">
    ...
    <div class="container app-dashboard__body">
        ...
        <form class="config-form" method="post" action="<?= billo_e(billo_url('/system/configuration')) ?>">
            ...
            <p class="hint" style="margin:0 0 1rem">All sections save together. Tabs only organize the form.</p>
            <div class="org-settings-tabs config-form-tabs" data-billo-form-tabs data-billo-default-tab="core">
                <div class="org-settings-tablist" role="tablist" aria-label="Configuration sections">
                    <button type="button" class="org-settings-tab" role="tab" data-billo-tab="core" aria-selected="true" tabindex="0">App &amp; brand</button>
                    <button type="button" class="org-settings-tab" role="tab" data-billo-tab="mail" aria-selected="false" tabindex="-1">Mail</button>
                    <button type="button" class="org-settings-tab" role="tab" data-billo-tab="payments" aria-selected="false" tabindex="-1">Payments</button>
                    <button type="button" class="org-settings-tab" role="tab" data-billo-tab="security" aria-selected="false" tabindex="-1">Session &amp; auth</button>
                    <button type="button" class="org-settings-tab" role="tab" data-billo-tab="platform" aria-selected="false" tabindex="-1">Platform</button>
                </div>
                <div class="org-settings-panels">
                    <div class="org-settings-panel" role="tabpanel" data-billo-panel="core">
                    ...
                    <div class="org-settings-panel" role="tabpanel" data-billo-panel="mail" hidden>
                        <fieldset class="config-form__section welcome-card">
                    ...
                    <div class="org-settings-panel" role="tabpanel" data-billo-panel="payments" hidden>
                        <fieldset class="config-form__section welcome-card">
                    ...
                    <div class="org-settings-panel" role="tabpanel" data-billo-panel="security" hidden>
                        <fieldset class="config-form__section welcome-card">
                    ...
                    <div class="org-settings-panel" role="tabpanel" data-billo-panel="platform" hidden>
                        <fieldset class="config-form__section welcome-card">
