    ...
    public function updateBranding(int $organizationId, array $data): bool
    {
        $stmt = Database::pdo()->prepare(
            'UPDATE organizations SET
                ...
                invoice_bank_code = :invoice_bank_code,
                invoice_bank_account_name = :invoice_bank_account_name,
                invoice_bank_account_number = :invoice_bank_account_number,
        ...
        $stmt->execute([
            ...
            'invoice_bank_code' => $data['invoice_bank_code'],
            'invoice_bank_account_name' => $data['invoice_bank_account_name'],
            'invoice_bank_account_number' => $data['invoice_bank_account_number'],
