...
$router->post('/platform/landing/faqs', static fn () => (new PlatformLandingController($request))->saveFaqs());
$router->post('/platform/landing/trusted', static fn () => (new PlatformLandingController($request))->saveTrusted());
$router->post('/platform/landing/testimonials', static fn () => (new PlatformLandingController($request))->saveTestimonials());
